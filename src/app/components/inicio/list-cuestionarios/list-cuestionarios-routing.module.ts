...
const routes: Routes = [
  ...
  {path:'nombre',component:IngresarNombreComponent},
  {path:'Responder',component:PreguntaComponent},
  {path:'resultado/respuestas',component:RespuestaCuestionarioComponent},
  {path:'**', redirectTo:'Responder'}
